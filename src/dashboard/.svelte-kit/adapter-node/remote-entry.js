import {
	get_request_store, with_request_store,
...
import {
	u as stringify_remote_arg, M as MUTATIVE_METHODS, v as create_field_proxy, w as normalize_issue, x as set_nested_value, y as flatten_issues, z as deep_set, k as stringify, f as create_remote_key, h as handle_error_and_jsonify,
} from './chunks/shared.js';
import {
	ValidationError, HttpError, SvelteKitError,
} from '@sveltejs/kit/internal';
import { d as dev } from './chunks/false.js';
import {
	b as base, c as app_dir,
...
function batch(validate_or_fn, maybe_fn) {
	...
	const wrapper = arg => {
		...
		const get_remote_function_result = () => new Promise((resolve, reject) => {
...
}, value, is_immediate_refresh = false) {
