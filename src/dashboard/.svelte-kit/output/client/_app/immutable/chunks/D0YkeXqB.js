import{
	r as a, h as e, H as l, g as h,
}from'./D2-oBDD7.js';let I, V, B, A, N, R, O, Z, $;const j={
	...
	}, U=(V=(I=window.$discordMessage)===null||I===void 0?void 0:I.avatars)!==null&&V!==void 0?V:{}, x=Object.assign(j, U, { default:(A=(B=j[U.default])!==null&&B!==void 0?B:U.default)!==null&&A!==void 0?A:j.blue }), L=(R=(N=window.$discordMessage)===null||N===void 0?void 0:N.profiles)!==null&&R!==void 0?R:{}, ie=((O=window.$discordMessage)===null||O===void 0?void 0:O.defaultTheme)==='light'?'light':'dark', oe=((Z=window.$discordMessage)===null||Z===void 0?void 0:Z.defaultMode)==='compact'?'compact':'cozy', re=(($=window.$discordMessage)===null||$===void 0?void 0:$.defaultBackground)==='none'?'none':'discord', se='.discord-action-row{display:flex;flex-wrap:nowrap}', te=class{
		constructor(i){
			a(this, i);
		}render(){
			return e(l, { class:'discord-action-row' }, e('slot', null));
		}
	};te.style=se;const de=i=>{
		const[o, r, s]=i.split('/');return`${o.padStart(2, '0')}/${r.padStart(2, '0')}/${s}`;
	}, ae=i=>i instanceof Date?de(`${i.getMonth()+1}/${i.getDate()}/${i.getFullYear()}`):i, ce=(i, o=!1)=>{
		if(!(i instanceof Date))return i;if(o)return`${i.getHours()}:${i.getMinutes().toString().padStart(2, '0')}`;const r=i.getHours()%12||12, s=i.getHours()<12?'AM':'PM';return`${r}:${i.getMinutes().toString().padStart(2, '0')} ${s}`;
	}, C=(i, o=!1, r=!1)=>{
		if(!(i instanceof Date)&&typeof i!=='string')throw new TypeError('Timestamp prop must be a Date object or a string.');return o?ce(i, r):ae(i);
	}, G=/\.(bmp|jpe?g|png|gif|webp|tiff)$/i, ne=i=>{
		if(!G.test(i))throw new Error(`The url of an image for discord-attachment should match the regex ${G}`);
	}, W=i=>{
		let o, r;return(r=(o=window.$discordMessage)===null||o===void 0?void 0:o.emojis)===null||r===void 0?void 0:r[i];
	}, le='.discord-attachment{color:#dcddde;display:flex;font-size:13px;line-height:150%;margin-bottom:8px;margin-top:8px}.discord-attachment .discord-image-wrapper{display:block;position:relative;-webkit-user-select:text;-moz-user-select:text;-ms-user-select:text;user-select:text;overflow:hidden;border-radius:3px}', me=class{
		constructor(i){
			a(this, i), this.url=void 0, this.height=void 0, this.width=void 0, this.alt='discord attachment';
		}componentWillRender(){
			ne(this.url);
		}render(){
			return e(l, { class:'discord-attachment' }, e('div', {
...
}const ue='.discord-button{display:flex;justify-content:center;align-items:center;cursor:pointer;margin:4px 8px 4px 0;padding:2px 16px;width:auto;height:32px;min-width:60px;min-height:32px;-webkit-transition:background-color 0.17s ease, color 0.17s ease;transition:background-color 0.17s ease, color 0.17s ease;border-radius:3px;font-size:14px;font-weight:500;line-height:16px;text-decoration:none !important}.discord-button.discord-button-success{color:#fff;background-color:#3ba55d}.discord-button.discord-button-success.discord-button-hoverable:hover{background-color:#2d7d46}.discord-button.discord-button-destructive{color:#fff;background-color:#ed4245}.discord-button.discord-button-destructive.discord-button-hoverable:hover{background-color:#c03537}.discord-button.discord-button-primary{color:#fff;background-color:#5865f2}.discord-button.discord-button-primary.discord-button-hoverable:hover{background-color:#4752c4}.discord-button.discord-button-secondary{color:#fff;background-color:#4f545c}.discord-button.discord-button-secondary.discord-button-hoverable:hover{background-color:#5d6269}.discord-button.discord-button-disabled{cursor:not-allowed;opacity:0.5}.discord-button .discord-button-launch{margin-left:8px}.discord-button .discord-button-emoji{margin-right:4px;object-fit:contain;width:1.375em;height:1.375em;vertical-align:bottom}', fe=class{
	constructor(i){
		a(this, i), this.emoji=void 0, this.emojiName='emoji', this.url=void 0, this.disabled=!1, this.type='secondary';
	}handleType(i){
		if(typeof i!=='string')throw new TypeError('DiscordButton `type` prop must be a string.');if(!['primary', 'secondary', 'success', 'destructive'].includes(i))throw new RangeError('DiscordButton `type` prop must be one of: \'primary\', \'secondary\', \'success\', \'destructive\'');
	}render(){
		if(this.el.parentElement.tagName.toLowerCase()!=='discord-action-row')throw new Error('All <discord-button> components must be direct children of <discord-action-row>.');const o=e(f, null, this.emoji&&e('img', {
			src:this.emoji,
			alt:this.emojiName,
			draggable:!1,
			class:'discord-button-emoji',
		}), e('span', null, e('slot', null)), this.url&&e(pe, { class:'discord-button-launch' }));return this.url&&!this.disabled?e('a', {
			class:'discord-button discord-button-secondary',
			href:this.url,
			target:'_blank',
			rel:'noopener noreferrer',
		}, o):e(l, { class:`discord-button discord-button-${this.type} discord-button-${this.disabled?'disabled':'hoverable'}` }, o);
	}get el(){
		return h(this);
	}static get watchers(){
		return{ type:['handleType'] };
	}
};fe.style=ue;function be(i){
	return e('svg', Object.assign({}, i, {
		width:'6',
		height:'10',
		viewBox:'0 0 6 10',
		...
		constructor(i){
			...
			let i, o, r;const s=this.el.parentElement;if(s.tagName.toLowerCase()!=='discord-message')throw new Error('All <discord-command> components must be direct children of <discord-message>.');const d=b=>{
				...
				}, n=(i=Reflect.get(L, this.profile))!==null&&i!==void 0?i:{}, c=Object.assign(Object.assign(Object.assign({}, t), n), { avatar:d((o=n.avatar)!==null&&o!==void 0?o:this.avatar) }), g=s.parentElement;return e(l, { class:'discord-replied-message discord-executed-command' }, g.compactMode?e('div', { class:'discord-reply-badge' }, e(be, null)):e('img', {
				class:'discord-replied-message-avatar',
				src:c.avatar,
				alt:c.author,
			}), e('span', {
				class:'discord-replied-message-username',
				style:{ color:(r=c.roleColor)!==null&&r!==void 0?r:'' },
			}, c.author), ' used ', e('div', { class:'discord-replied-message-content discord-command-name' }, this.command));
		}get el(){
			return h(this);
		}
	};xe.style=ve;const we='.discord-custom-emoji{display:inline-block;cursor:pointer}.discord-custom-emoji .discord-custom-emoji-image{object-fit:contain;width:1.375rem;height:1.375rem;vertical-align:bottom}.discord-embed-custom-emoji{display:inline-block}.discord-embed-custom-emoji .discord-embed-custom-emoji-image{width:18px;height:18px;vertical-align:bottom}', ye=class{
	constructor(i){
		a(this, i), this.name=void 0, this.url=void 0, this.embedEmoji=void 0;
	}componentWillRender(){
		let i, o, r, s;if(!this.url&&this.name){
			const d=W(this.name);d&&((i=this.url)!==null&&i!==void 0||(this.url=(o=d.url)!==null&&o!==void 0?o:''), (r=this.embedEmoji)!==null&&r!==void 0||(this.embedEmoji=(s=d.embedEmoji)!==null&&s!==void 0?s:!1));
		}
	}render(){
		const i=`:${this.name}:`, o=this.embedEmoji?'discord-embed-custom-emoji':'discord-custom-emoji', r=this.embedEmoji?'discord-embed-custom-emoji-image':'discord-custom-emoji-image';return e('span', { class:o }, e('img', {
			'aria-label':i,
			src:this.url,
			alt:i,
			draggable:!1,
	...
	constructor(i){
		...
		const i=this.parseTitle(this.authorName), o=this.parseTitle(this.embedTitle);return e('div', { class:'discord-embed' }, e('div', {
			...
			target:'_blank',
			rel:'noopener noreferrer',
		}, ...i):e(f, null, ...i)), o&&e('div', { class:'discord-embed-title' }, this.url?e('a', {
			href:this.url,
			target:'_blank',
			rel:'noopener noreferrer',
		}, ...o):e(f, null, ...o)), this.hasProvidedDescriptionSlot&&e('slot', { name:'description' }), e('slot', { name:'fields' }), this.image||this.video?e('div', { class:y('discord-embed-media', { 'discord-embed-media-video':!!this.video }) }, this.renderMedia()):null, this.thumbnail?e('img', {
			src:this.thumbnail,
			alt:'',
			class:'discord-embed-thumbnail',
		}):'', e('slot', { name:'footer' })))));
	}renderMedia(){
		return this.video?e('video', {
			controls:!0,
			muted:!0,
			preload:'none',
			poster:this.image,
	...
	constructor(i){
		...
		}, o&&e('div', { class:'discord-field-title' }, [...o]), e('slot', null));
	}parseTitle(i){
		if(!i)return null;const o=i.split(' ');return o.map((r, s)=>{
			let d;const t=(d=W(r))!==null&&d!==void 0?d:{};let n='';return t.name?n=e('span', { class:'discord-embed-custom-emoji' }, e('img', {
				src:t.url,
...
};He.style=Me;const _e='.discord-embed .discord-embed-fields{display:grid;grid-column:1/1;margin-top:8px;grid-gap:8px}', Ee=class{
	constructor(i){
		a(this, i);
	}render(){
		return e(l, { class:'discord-embed-fields' }, e('slot', null));
	}
};Ee.style=_e;const De='.discord-embed-footer{-webkit-box-align:center;align-items:center;color:#dcddde;display:flex;font-size:12px;line-height:16px;font-weight:500;grid-column:1/3;grid-row:auto/auto;margin-top:8px}.discord-embed-footer .discord-footer-image{border-radius:50%;flex-shrink:0;height:20px;margin-right:8px;width:20px}.discord-embed-footer .discord-footer-separator{color:#dcddde;font-weight:500;display:inline-block;margin:0 4px}.discord-light-theme .discord-embed-footer .discord-footer-separator{color:#e4e4e4}', ze=class{
	constructor(i){
		a(this, i), this.footerImage=void 0, this.timestamp=void 0;
	}updateTimestamp(i){
		return!i||isNaN(new Date(i).getTime())?null:C(new Date(i));
	}componentWillRender(){
		this.timestamp=this.updateTimestamp(this.timestamp);
	}render(){
		if(this.el.parentElement.tagName.toLowerCase()!=='div')throw new Error('All <discord-embed-footer> components must be direct children of <discord-embed>.');return e(l, { class:'discord-embed-footer' }, this.footerImage?e('img', {
			src:this.footerImage,
			alt:'',
			class:'discord-footer-image',
		}):'', e(f, null, e('slot', null), this.timestamp?e('span', { class:'discord-footer-separator' }, '•'):'', this.timestamp?e(f, null, this.timestamp):''));
	}get el(){
		return h(this);
	}static get watchers(){
		return{ timestamp:['updateTimestamp'] };
	}
};ze.style=De;const Bi=class{
	constructor(i){
		a(this, i);
	}render(){
		return e('code', null, e('slot', null));
	}
};function Se(i){
	return e('svg', Object.assign({}, i, {
		'aria-hidden':'false',
	...
	};Be.style=Ve;const Ai=class{
	constructor(i){
		a(this, i);
	}render(){
		return e('em', null, e('slot', null));
	}
};const Ae=function(o){
		return o.charAt(0)==='#'?o.slice(1):o;
	}, Ne=function(o){
		const r=o.length===3||o.length===4, s=r?''.concat(o.slice(0, 1)).concat(o.slice(0, 1)):o.slice(0, 2), d=r?''.concat(o.slice(1, 2)).concat(o.slice(1, 2)):o.slice(2, 4), t=r?''.concat(o.slice(2, 3)).concat(o.slice(2, 3)):o.slice(4, 6), n=(r?''.concat(o.slice(3, 4)).concat(o.slice(3, 4)):o.slice(6, 8))||'ff';return{
			r:s,
			g:d,
			b:t,
			a:n,
		...
		const r=o.r, s=o.g, d=o.b, t=o.a;return{
			r:k(r),
			g:k(s),
			b:k(d),
			a:+(k(t)/255).toFixed(2),
		...
		const s=o.r, d=o.g, t=o.b, n=o.a, c=Oe(r)?r:n;return'rgba('.concat(s, ', ').concat(d, ', ').concat(t, ', ').concat(c, ')');
	}, $e=function(o, r){
		const s=Ae(o), d=Ne(s), t=Re(d);return Ze(t, r);
	}, P=$e;function Ue(i){
	return e('svg', Object.assign({}, i, {
		'aria-hidden':'false',
		width:'24',
...
}const Ge='.discord-message .discord-mention{color:#e3e7f8;background-color:hsla(235, 85.6%, 64.7%, 0.3);font-weight:500;padding:0 2px;border-radius:3px;unicode-bidi:-moz-plaintext;unicode-bidi:plaintext;-webkit-transition:background-color 50ms ease-out, color 50ms ease-out;transition:background-color 50ms ease-out, color 50ms ease-out;cursor:pointer}.discord-message .discord-mention:hover{color:#fff;background-color:hsl(235, 85.6%, 64.7%)}.discord-message .discord-mention.discord-channel-mention{padding-left:1.2rem !important;position:relative}.discord-message .discord-mention.discord-voice-mention,.discord-message .discord-mention.discord-locked-mention,.discord-message .discord-mention.discord-thread-mention,.discord-message .discord-mention.discord-forum-mention{padding-left:1.25rem !important;position:relative}.discord-light-theme .discord-message .discord-mention{color:#687dc6;background-color:hsla(235, 85.6%, 64.7%, 0.15)}.discord-light-theme .discord-message .discord-mention:hover{color:#ffffff;background-color:hsl(235, 85.6%, 64.7%)}.discord-message .discord-mention .discord-mention-icon{width:1rem;height:1rem;object-fit:contain;position:absolute;left:0.125rem;top:0.125rem}', Je=class{
	constructor(i){
		a(this, i), this.highlight=!1, this.color=void 0, this.type='user';
	}handleType(i){
		if(typeof i!=='string')throw new TypeError('DiscordMention `type` prop must be a string.');if(!['user', 'channel', 'role', 'voice', 'locked', 'thread', 'forum', 'slash'].includes(i))throw new RangeError('DiscordMention `type` prop must be one of: \'user\', \'channel\', \'role\', \'voice\', \'locked\', \'thread\', \'forum\', \'slash\'');
	}componentWillRender(){
		this.handleType(this.type);
	}componentDidLoad(){
		this.color&&this.type==='role'&&(this.el.addEventListener('mouseover', this.setHoverColor.bind(this)), this.el.addEventListener('mouseout', this.resetHoverColor.bind(this)));
	}disconnectedCallback(){
		this.color&&this.type==='role'&&(this.el.removeEventListener('mouseover', this.setHoverColor.bind(this)), this.el.removeEventListener('mouseout', this.resetHoverColor.bind(this)));
	}setHoverColor(){
		this.el.style.backgroundColor=P(this.color, .3);
	}resetHoverColor(){
		this.el.style.backgroundColor=P(this.color, .1);
	}render(){
		const{
				color:i, type:o,
			}=this, r=!i||o!=='role'?{}:{
				color:i,
				'background-color':P(i, .1),
			};let s='';switch(this.type){
		case'channel':s=e(Pe, { class:'discord-mention-icon' });break;case'user':case'role':s='@';break;case'voice':s=e(qe, { class:'discord-mention-icon' });break;case'locked':s=e(Fe, { class:'discord-mention-icon' });break;case'thread':s=e(We, { class:'discord-mention-icon' });break;case'forum':s=e(Ue, { class:'discord-mention-icon' });break;case'slash':s='/';break;
		}return e(l, {
			style:r,
			class:`discord-mention discord-${o}-mention`,
		}, s, e('slot', null));
	}get el(){
		return h(this);
	}static get watchers(){
		...
		author:i, bot:o, server:r, op:s, roleColor:d, roleIcon:t, roleName:n, verified:c, compact:g,
	})=>e('span', { class:'discord-author-info' }, !g&&e(f, null, e('span', {
		...
		alt:n,
		draggable:!1,
	})), e(f, null, o&&!r&&e('span', { class:'discord-application-tag' }, c&&e(F, null), 'Bot'), r&&!o&&e('span', { class:'discord-application-tag' }, 'Server'), s&&e('span', { class:'discord-application-tag discord-application-tag-op' }, 'OP')), g&&e('span', {
		class:'discord-author-username',
		style:{ color:d },
	}, i));function Qe(i){
	return e('svg', Object.assign({}, i, {
...
}const Ye=`.discord-message{color:#dcddde;display:flex;flex-direction:column;font-size:0.9em;font-family:Whitney, 'Source Sans Pro', ui-sans-serif, system-ui, -apple-system, 'system-ui', 'Segoe UI', Roboto, 'Helvetica Neue', Arial,
		...
		constructor(i){
			...
			let i, o, r, s, d, t, n, c, g, b, p, u, M, H, _, E, D, z;const w=this.el.parentElement;if(w.tagName.toLowerCase()!=='discord-messages')throw new Error('All <discord-message> components must be direct children of <discord-messages>.');const Y=v=>{
				...
				}, q=(i=Reflect.get(L, this.profile))!==null&&i!==void 0?i:{}, m=Object.assign(Object.assign(Object.assign({}, K), q), { avatar:Y((o=q.avatar)!==null&&o!==void 0?o:this.avatar) }), X=Array.from(this.el.children).some(v=>v.tagName.toLowerCase()==='discord-mention'&&v.highlight&&['user', 'role'].includes(v.type))||this.highlight, ee=Array.from(this.el.children).some(v=>v.tagName.toLowerCase()==='discord-thread');return e(l, {
				class:y('discord-message', {
					'discord-highlight-mention':X,
					'discord-message-has-thread':ee,
					'discord-highlight-ephemeral':this.ephemeral,
				}),
			}, e('slot', { name:'reply' }), e('div', { class:'discord-message-inner' }, w.compactMode&&e('span', { class:'discord-message-timestamp' }, this.timestamp), e('div', { class:'discord-author-avatar' }, e('img', {
				src:m.avatar,
				alt:m.author,
			})), e('div', { class:'discord-message-content' }, !w.compactMode&&e(f, null, e(J, {
				author:(r=m.author)!==null&&r!==void 0?r:'',
				bot:(s=m.bot)!==null&&s!==void 0?s:!1,
				server:(d=m.server)!==null&&d!==void 0?d:!1,
				verified:(t=m.verified)!==null&&t!==void 0?t:!1,
				op:(n=m.op)!==null&&n!==void 0?n:!1,
				roleColor:(c=m.roleColor)!==null&&c!==void 0?c:'',
				roleIcon:(g=m.roleIcon)!==null&&g!==void 0?g:'',
				roleName:(b=m.roleName)!==null&&b!==void 0?b:'',
				compact:w.compactMode,
			}), e('span', { class:'discord-message-timestamp' }, this.timestamp)), e('div', { class:'discord-message-body' }, w.compactMode&&e(J, {
				author:(p=m.author)!==null&&p!==void 0?p:'',
				bot:(u=m.bot)!==null&&u!==void 0?u:!1,
				server:(M=m.server)!==null&&M!==void 0?M:!1,
				verified:(H=m.verified)!==null&&H!==void 0?H:!1,
				op:(_=m.op)!==null&&_!==void 0?_:!1,
				roleColor:(E=m.roleColor)!==null&&E!==void 0?E:'',
				roleIcon:(D=m.roleIcon)!==null&&D!==void 0?D:'',
				roleName:(z=m.roleName)!==null&&z!==void 0?z:'',
				compact:w.compactMode,
			}), e('span', { class:'discord-message-markup' }, e('slot', null)), this.edited?e('span', { class:'discord-message-edited' }, '(edited)'):''), e('div', { class:'discord-message-compact-indent' }, e('slot', { name:'embeds' }), e('slot', { name:'attachments' }), e('slot', { name:'components' }), e('slot', { name:'reactions' }), e('slot', { name:'thread' }), this.ephemeral&&e('div', { class:'discord-message-ephemeral' }, e(Qe, { class:'discord-message-ephemeral-icon' }), 'Only you can see this • ', e('span', { class:'discord-message-ephemeral-link' }, 'Dismiss message'))))));
		}get el(){
			return h(this);
		}static get watchers(){
			return{ timestamp:['updateTimestamp'] };
		}
	};Ke.style=Ye;const Xe=`@import url('https://fonts.bunny.net/css?family=roboto:400,500,700');@font-face{font-family:'Whitney';src:url('https://cdn.skyra.pw/whitney-font/v2/Book.woff') format('woff');font-weight:400}@font-face{font-family:'Whitney';src:url('https://cdn.skyra.pw/whitney-font/v2/Medium.woff') format('woff');font-weight:500}@font-face{font-family:'Whitney';src:url('https://cdn.skyra.pw/whitney-font/v2/Semibold.woff') format('woff');font-weight:600}@font-face{font-family:'Whitney';src:url('https://cdn.skyra.pw/whitney-font/v2/Bold.woff') format('woff');font-weight:700}.discord-messages{color:#fff;background-color:#36393e;display:block;font-size:16px;font-family:Whitney, 'Source Sans Pro', ui-sans-serif, system-ui, -apple-system, 'system-ui', 'Segoe UI', Roboto, 'Helvetica Neue', Arial,
		sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji';line-height:170%;border:1px solid rgba(255, 255, 255, 0.05)}.discord-messages.discord-light-theme{color:#747f8d;background-color:#fff;border-color:#dedede}.discord-messages.discord-no-background{background-color:unset}`, ei=class{
		constructor(i){
			a(this, i), this.lightTheme=void 0, this.noBackground=void 0, this.compactMode=void 0;
		}componentWillRender(){
			(this.lightTheme||ie==='light'&&this.lightTheme)&&(this.lightTheme=!0), (this.compactMode||oe==='compact'&&this.compactMode)&&(this.compactMode=!0), (this.noBackground||re==='none'&&this.noBackground)&&(this.noBackground=!0);
		}render(){
			return e(l, {
				class:y({
	...
	};ei.style=Xe;const ii='.discord-message .discord-message-body .discord-quote-container{display:flex}.discord-message .discord-message-body .discord-quote-container>.discord-quote-divider{background-color:#4f545c;border-radius:4px;font-size:0.9em;font-style:normal;font-weight:400;margin:0;padding:0;width:4px}.discord-message .discord-message-body blockquote{margin-block-end:unset;margin-block-start:unset;margin-inline-end:unset;margin-inline-start:unset;padding:0 8px 0 12px}', oi=class{
	constructor(i){
		a(this, i);
	}render(){
		return e(l, { class:'discord-quote-container' }, e('div', { class:'discord-quote-divider' }), e('blockquote', null, e('slot', null)));
	}
};oi.style=ii;const ri='.discord-reaction{border-radius:0.5rem;cursor:pointer;flex-shrink:0;margin-right:0.25rem;margin-bottom:0.25rem;user-select:none;transition:none 0.1s ease;transition-property:background-color, border-color;background-color:#2f3136;border:1px solid transparent}.discord-light-theme .discord-reaction{background-color:#f2f3f5}.discord-reaction:hover{background-color:#36393f;border-color:#fff2}.discord-light-theme .discord-reaction:not(.discord-reaction-reacted):hover{background-color:white;border-color:#0003}.discord-reaction.discord-reaction-reacted{background-color:rgba(88, 101, 242, 0.15);border-color:#5865f2}.discord-light-theme .discord-reaction.discord-reaction-reacted{background-color:#e7e9fd}.discord-reaction .discord-reaction-inner{display:flex;align-items:center;padding:0.125rem 0.375rem}.discord-reaction img{width:1rem;height:1rem;margin:0.125rem 0;min-width:auto;min-height:auto;object-fit:contain;vertical-align:bottom}.discord-reaction .discord-reaction-count{font-size:0.875rem;font-weight:500;margin-left:0.375rem;text-align:center;color:#b9bbbe}.discord-light-theme .discord-reaction .discord-reaction-count{color:#4f5660}.discord-reaction.discord-reaction-reacted .discord-reaction-count{color:#dee0fc}.discord-light-theme .discord-reaction.discord-reaction-reacted .discord-reaction-count{color:#5865f2}', si=class{
	constructor(i){
		a(this, i), this.emoji=void 0, this.name=':emoji:', this.count=1, this.reacted=!1, this.interactive=!1;
	}render(){
		return e('div', {
			class:y('discord-reaction', { 'discord-reaction-reacted':this.reacted }),
			onClick:this.handleReactionClick.bind(this),
		}, e('div', { class:'discord-reaction-inner' }, e('img', {
			src:this.emoji,
			alt:this.name,
			draggable:!1,
		}), e('span', { class:'discord-reaction-count' }, this.count)));
	}handleReactionClick(i){
		this.interactive&&(i.shiftKey?this.count--:this.count++, this.count<=0&&(this.count=1));
	}get el(){
		return h(this);
	}
};si.style=ri;const ti='.discord-message .discord-reactions,.discord-system-message .discord-reactions{display:flex;-webkit-box-flex:1;-ms-flex:1 0 auto;flex:1 0 auto;align-items:center;flex-wrap:wrap}', di=class{
	constructor(i){
		a(this, i);
	}render(){
		return e(l, { class:'discord-reactions' }, e('slot', null));
	}
};di.style=ti;function ai(i){
	return e('svg', Object.assign({}, i, {
		'aria-hidden':'false',
		width:'64',
		height:'64',
...
}const li=`.discord-replied-message{color:#b9bbbe;display:flex;font-size:0.875rem;font-family:Whitney, 'Source Sans Pro', ui-sans-serif, system-ui, -apple-system, 'system-ui', 'Segoe UI', Roboto, 'Helvetica Neue', Arial,
		sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji';padding-top:2px;margin-left:56px;margin-bottom:4px;align-items:center;line-height:1.125rem;position:relative;white-space:pre;user-select:none}.discord-light-theme .discord-replied-message{color:#4f5660}.discord-compact-mode .discord-replied-message{margin-left:62px;margin-bottom:0}.discord-replied-message:before{content:'';display:block;position:absolute;top:50%;right:100%;bottom:0;left:-36px;margin-right:4px;margin-top:-1px;margin-left:-1px;margin-bottom:-2px;border-left:2px solid #4f545c;border-bottom:0 solid #4f545c;border-right:0 solid #4f545c;border-top:2px solid #4f545c;border-top-left-radius:6px}.discord-light-theme .discord-replied-message:before{border-color:#747f8d}.discord-replied-message .discord-replied-message-avatar,.discord-replied-message .discord-reply-badge{-webkit-box-flex:0;-ms-flex:0 0 auto;flex:0 0 auto;width:16px;height:16px;border-radius:50%;user-select:none;margin-right:0.25rem}.discord-replied-message .discord-reply-badge{display:flex;align-items:center;justify-content:center;color:#b9bbbe;background:#202225}.discord-light-theme .discord-replied-message .discord-reply-badge{color:#4f5660;background:#e3e5e8}.discord-replied-message .discord-application-tag{background-color:hsl(235, 85.6%, 64.7%);color:#fff;font-size:0.625rem;margin-right:0.25rem;line-height:100%;text-transform:uppercase;display:flex;align-items:center;height:0.9375rem;padding:0 0.275rem;margin-top:0.075em;border-radius:0.1875rem}.discord-replied-message .discord-application-tag .discord-application-tag-verified{width:0.9375rem;height:0.9375rem;margin-left:-0.1rem}.discord-replied-message .discord-application-tag.discord-application-tag-op{background-color:#c9cdfb;color:#4752c4;border-radius:0.4rem}.discord-replied-message .discord-replied-message-username{flex-shrink:0;font-size:inherit;line-height:inherit;margin-right:0.25rem;opacity:0.64;font-weight:500;color:#fff}.discord-replied-message .discord-replied-message-content{color:inherit;font-size:inherit;line-height:inherit;white-space:pre;text-overflow:ellipsis;user-select:none;cursor:pointer}.discord-replied-message .discord-replied-message-content:hover{color:#fff}.discord-light-theme .discord-replied-message .discord-replied-message-content:hover{color:#000}.discord-replied-message .discord-replied-message-content .discord-message-edited{margin-left:0.25rem}.discord-replied-message .discord-replied-message-content-icon{-webkit-box-flex:0;-ms-flex:0 0 auto;flex:0 0 auto;width:20px;height:20px;margin-left:4px}.discord-message .discord-author-info{display:inline-flex;align-items:center;font-size:16px;margin-right:0.25rem}.discord-compact-mode .discord-message .discord-author-info{margin-right:0}.discord-message .discord-author-info .discord-author-username{color:#fff;font-size:1em;font-weight:500}.discord-light-theme .discord-message .discord-author-info .discord-author-username{color:#23262a}.discord-message .discord-author-info .discord-application-tag{background-color:#5865f2;color:#fff;font-size:0.625em;margin-left:4px;border-radius:3px;line-height:100%;text-transform:uppercase;display:flex;align-items:center;height:0.9375rem;padding:0 0.275rem;margin-top:0.075em;border-radius:0.1875rem}.discord-message .discord-author-info .discord-application-tag.discord-application-tag-op{background-color:#c9cdfb;color:#4752c4;border-radius:0.4rem}.discord-message .discord-author-info .discord-application-tag-verified{display:inline-block;width:0.9375rem;height:0.9375rem;margin-left:-0.25rem}.discord-message .discord-author-info .discord-author-role-icon{margin-left:0.25rem;vertical-align:top;height:calc(1rem + 4px);width:calc(1rem + 4px)}.discord-compact-mode .discord-message .discord-author-info .discord-author-username{margin-left:8px;margin-right:4px}.discord-compact-mode .discord-message .discord-author-info .discord-application-tag{margin-left:0;margin-left:5px;margin-right:5px;padding-left:10px;padding-right:4px}.discord-compact-mode .discord-message .discord-author-info .discord-application-tag-verified{margin-right:0.7em;margin-left:-0.7em}`, mi=class{
		constructor(i){
			a(this, i), this.profile=void 0, this.author='User', this.avatar=void 0, this.bot=!1, this.server=!1, this.op=!1, this.verified=!1, this.edited=!1, this.roleColor=void 0, this.command=!1, this.attachment=!1, this.mentions=!1;
		}render(){
			let i, o, r;const s=this.el.parentElement;if(s.tagName.toLowerCase()!=='discord-message')throw new Error('All <discord-reply> components must be direct children of <discord-message>.');const d=b=>{
					let p, u;return(u=(p=x[b])!==null&&p!==void 0?p:b)!==null&&u!==void 0?u:x.default;
				}, t={
					author:this.author,
					bot:this.bot,
					...
					server:this.server,
					roleColor:this.roleColor,
				}, n=(i=Reflect.get(L, this.profile))!==null&&i!==void 0?i:{}, c=Object.assign(Object.assign(Object.assign({}, t), n), { avatar:d((o=n.avatar)!==null&&o!==void 0?o:this.avatar) }), g=s.parentElement;return e(l, { class:'discord-replied-message' }, g.compactMode?e('div', { class:'discord-reply-badge' }, e(ni, null)):e('img', {
				class:'discord-replied-message-avatar',
				src:c.avatar,
				alt:c.author,
			}), e(f, null, c.bot&&!c.server&&e('span', { class:'discord-application-tag' }, c.verified&&e(F, null), 'Bot'), c.server&&!c.bot&&e('span', { class:'discord-application-tag' }, 'Server'), c.op&&e('span', { class:'discord-application-tag discord-application-tag-op' }, 'OP')), e('span', {
				class:'discord-replied-message-username',
				style:{ color:(r=c.roleColor)!==null&&r!==void 0?r:'' },
			}, this.mentions&&'@', c.author), e('div', { class:'discord-replied-message-content' }, e('slot', null), this.edited?e('span', { class:'discord-message-edited' }, '(edited)'):''), this.command?e(ci, { class:'discord-replied-message-content-icon' }):this.attachment&&e(ai, { class:'discord-replied-message-content-icon' }));
		}get el(){
			return h(this);
		}
	};mi.style=li;const hi='.discord-message .discord-message-body .discord-spoiler{background-color:#202225;color:transparent;cursor:pointer}.discord-light-theme .discord-message .discord-message-body .discord-spoiler{background-color:#b9bbbe}.discord-message .discord-message-body .discord-spoiler:hover{background-color:rgba(32, 34, 37, 0.8)}.discord-light-theme .discord-message .discord-message-body .discord-spoiler:hover{background-color:rgba(185, 187, 190, 0.8)}.discord-message .discord-message-body .discord-spoiler:active{color:inherit;background-color:hsla(0, 0%, 100%, 0.1)}.discord-light-theme .discord-message .discord-message-body .discord-spoiler:active{background-color:rgba(0, 0, 0, 0.1)}', gi=class{
	constructor(i){
		a(this, i);
	}render(){
		return e(l, { class:'discord-spoiler' }, e('slot', null));
	}
};gi.style=hi;function pi(i){
	return e('svg', Object.assign({}, i, {
		'aria-hidden':'false',
		width:'24',
		height:'24',
	...
	return e('svg', Object.assign({}, i, {
		...
		fill:'none',
		'fill-rule':'evenodd',
	}, e('path', { d:'M18 0H0v18h18z' }), e('path', {
		fill:'#3ba55c',
	...
	};Li.style=ji;const Mi='.discord-tenor-video{color:#dcddde;display:flex;font-size:13px;line-height:150%;margin-bottom:8px;margin-top:8px}.discord-tenor-video .discord-tenor-video-wrapper{display:block;position:relative;-webkit-user-select:text;-moz-user-select:text;-ms-user-select:text;user-select:text;overflow:hidden;border-radius:4px}.discord-tenor-video .discord-tenor-video-wrapper video{-webkit-box-align:center;-webkit-box-pack:center;align-items:center;border-radius:0;cursor:pointer;display:flex;height:100%;justify-content:center;max-height:100%;width:100%;left:0px;top:0px}', Hi=class{
	constructor(i){
		a(this, i), this.url=void 0, this.height=void 0, this.width=void 0;
	}render(){
		return e(l, { class:'discord-tenor-video' }, e('div', {
	...
	constructor(i){
		...
		let i, o;const r=n=>{
				...
				server:this.server,
				roleColor:this.roleColor,
			}, d=(i=Reflect.get(L, this.profile))!==null&&i!==void 0?i:{}, t=Object.assign(Object.assign(Object.assign({}, s), d), { avatar:r((o=d.avatar)!==null&&o!==void 0?o:this.avatar) });return e(l, { class:'discord-thread-message' }, e('img', {
			src:t.avatar,
			class:'discord-thread-message-avatar',
			alt:t.author,
		}), e(f, null, t.bot&&!t.server&&e('span', { class:'discord-application-tag' }, t.verified&&e(F, null), 'Bot'), t.server&&!t.bot&&e('span', { class:'discord-application-tag' }, 'Server')), e('span', {
			class:'discord-thread-message-username',
			style:{ color:t.roleColor },
		}, t.author), e('div', { class:'discord-thread-message-content' }, e('slot', null), this.edited?e('span', { class:'discord-message-edited' }, '(edited)'):''), e('span', { class:'discord-thread-message-timestamp' }, this.relativeTimestamp));
	}get el(){
		return h(this);
	}
};zi.style=Di;const Si='.discord-time{background-color:#ffffff0f;border-radius:3px;padding:0 2px}', Ti=class{
	constructor(i){
		a(this, i);
	}render(){
		return e(l, { class:'discord-time' }, e('slot', null));
	}
};Ti.style=Si;const Ni=class{
	constructor(i){
		a(this, i);
	}render(){
		return e('u', null, e('slot', null));
	}
};export{
	te as discord_action_row, me as discord_attachment, ge as discord_attachments, Vi as discord_bold, fe as discord_button, xe as discord_command, ye as discord_custom_emoji, ke as discord_embed, Le as discord_embed_description, He as discord_embed_field, Ee as discord_embed_fields, ze as discord_embed_footer, Bi as discord_inline_code, Be as discord_invite, Ai as discord_italic, Je as discord_mention, Ke as discord_message, ei as discord_messages, oi as discord_quote, si as discord_reaction, di as discord_reactions, mi as discord_reply, gi as discord_spoiler, Li as discord_system_message, Hi as discord_tenor_video, Ei as discord_thread, zi as discord_thread_message, Ti as discord_time, Ni as discord_underlined,
};
