...
type LayoutRouteId = RouteId | "/(default)" | "/(default)/[guild]" | "/(default)/[guild]/feedback" | "/(default)/[guild]/staff" | "/(default)/[guild]/tickets" | "/(default)/invite" | "/(default)/login" | "/(default)/view/[ticket]"
type LayoutParams = RouteParams & { guild?: string; ticket?: string }
