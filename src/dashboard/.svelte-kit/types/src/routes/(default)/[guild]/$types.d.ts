...
type RouteParams = { guild: string };
type RouteId = '/(default)/[guild]';
...
type LayoutRouteId = RouteId | "/(default)/[guild]" | "/(default)/[guild]/feedback" | "/(default)/[guild]/staff" | "/(default)/[guild]/tickets"
type LayoutParams = RouteParams & { guild?: string }
