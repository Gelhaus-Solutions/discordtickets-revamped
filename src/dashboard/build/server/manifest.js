...
return {
	...
	_: {
		...
		nodes: [
			...
			__memo(() => import('./chunks/16-BGRQdHZa.js')),
			__memo(() => import('./chunks/17-CWSSefSk.js')),
			__memo(() => import('./chunks/18-CXgg5xSA.js')),
			__memo(() => import('./chunks/19-CtlMfWYT.js')),
			__memo(() => import('./chunks/20-CevULDgj.js')),
			__memo(() => import('./chunks/21-DTDwyimy.js')),
			__memo(() => import('./chunks/22-D5D2ifV3.js')),
			__memo(() => import('./chunks/23-BCBv8-em.js')),
			__memo(() => import('./chunks/24-CObf97be.js')),
			__memo(() => import('./chunks/25-BtWuJt6u.js')),
			__memo(() => import('./chunks/26-B8XEiQXD.js')),
			__memo(() => import('./chunks/27-56G-cHk_.js')),
			__memo(() => import('./chunks/28-X-A7u8CR.js')),
			__memo(() => import('./chunks/29-DAbUcNa2.js'))
		],
		remotes: {
