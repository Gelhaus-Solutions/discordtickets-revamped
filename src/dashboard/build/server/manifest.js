...
return {
	...
	_: {
		...
		nodes: [
			...
			__memo(() => import('./chunks/16-B2UDuzC6.js')),
			__memo(() => import('./chunks/17-BOljt24c.js')),
			__memo(() => import('./chunks/18-DKA3W23t.js')),
			__memo(() => import('./chunks/19-B3yEfrlK.js')),
			__memo(() => import('./chunks/20-BTeFJwNT.js')),
			__memo(() => import('./chunks/21-CkyjAxiE.js')),
			__memo(() => import('./chunks/22-DyGmdhZ_.js')),
			__memo(() => import('./chunks/23-Dn2-26x1.js')),
			__memo(() => import('./chunks/24-wmoSnJJ6.js')),
			__memo(() => import('./chunks/25-tSUIshKJ.js')),
			__memo(() => import('./chunks/26-nZpfDoI8.js'))
		],
		remotes: {
