...
return {
	...
	_: {
		...
		nodes: [
			...
			__memo(() => import('./chunks/16-BezDgr81.js')),
			__memo(() => import('./chunks/17-C7V4ZBA9.js')),
			__memo(() => import('./chunks/18-6IlIcu_z.js')),
			__memo(() => import('./chunks/19-nY2wQfRk.js')),
			__memo(() => import('./chunks/20-BjgTcr75.js')),
			__memo(() => import('./chunks/21-CH1_igOu.js')),
			__memo(() => import('./chunks/22-DxkS-1kM.js')),
			__memo(() => import('./chunks/23-BWwXmg_Y.js')),
			__memo(() => import('./chunks/24-B8cim_-H.js')),
			__memo(() => import('./chunks/25-C7KncF-K.js'))
		],
		remotes: {
