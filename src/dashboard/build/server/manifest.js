...
return {
	...
	_: {
		...
		nodes: [
			...
			__memo(() => import('./chunks/16-B9rx4nZB.js')),
			__memo(() => import('./chunks/17-DKlhLRte.js')),
			__memo(() => import('./chunks/18-8R7MElS0.js')),
			__memo(() => import('./chunks/19-XNJTXMi2.js')),
			__memo(() => import('./chunks/20-C9MFXv_o.js')),
			__memo(() => import('./chunks/21-maA9uLWS.js')),
			__memo(() => import('./chunks/22-HPQ3P1V2.js')),
			__memo(() => import('./chunks/23-BDUYBWk6.js')),
			__memo(() => import('./chunks/24-B1aAFHu2.js')),
			__memo(() => import('./chunks/25-kR9aruLb.js')),
			__memo(() => import('./chunks/26-VRG5xgZI.js')),
			__memo(() => import('./chunks/27-g8nknGW2.js')),
			__memo(() => import('./chunks/28-B1px_dMZ.js')),
			__memo(() => import('./chunks/29-CH-nOIp0.js'))
		],
		remotes: {
