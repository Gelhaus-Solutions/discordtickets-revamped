...
return {
	...
	_: {
		...
		nodes: [
			...
			__memo(() => import('./chunks/16-Chk7DpYv.js')),
			__memo(() => import('./chunks/17-CZMDvvlw.js')),
			__memo(() => import('./chunks/18-CP540K6y.js')),
			__memo(() => import('./chunks/19-Cn8CnMbr.js')),
			__memo(() => import('./chunks/20-BZnZRzUS.js')),
			__memo(() => import('./chunks/21-BUb6SdVv.js')),
			__memo(() => import('./chunks/22-B6tL4Nta.js')),
			__memo(() => import('./chunks/23-CFU-1igW.js')),
			__memo(() => import('./chunks/24-o-2XdOOR.js')),
			__memo(() => import('./chunks/25-B2qomjye.js'))
		],
		remotes: {
