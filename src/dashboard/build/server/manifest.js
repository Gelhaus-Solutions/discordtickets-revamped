...
return {
	...
	_: {
		...
		nodes: [
			...
			__memo(() => import('./chunks/1-CTk2n49E.js')),
			__memo(() => import('./chunks/2-ChQB2S7h.js')),
			__memo(() => import('./chunks/3-bcnirQmd.js')),
			__memo(() => import('./chunks/4-DcZaG7-e.js')),
			__memo(() => import('./chunks/5-DNLwZgWw.js')),
			__memo(() => import('./chunks/6-CAPMrxhp.js')),
			__memo(() => import('./chunks/7-CUNM3c2E.js')),
			__memo(() => import('./chunks/8-BKxyG2VD.js')),
			__memo(() => import('./chunks/9-D9e4l7UC.js')),
			...
			__memo(() => import('./chunks/16-BsLT4ncM.js')),
			__memo(() => import('./chunks/17-BE6jetg6.js')),
			__memo(() => import('./chunks/18-DeBKE3kM.js')),
			__memo(() => import('./chunks/19-BTKzQNCf.js')),
			__memo(() => import('./chunks/20-Cd2eflch.js')),
			__memo(() => import('./chunks/21-2CL3qgH6.js')),
			__memo(() => import('./chunks/22-C_2ay7zh.js')),
			__memo(() => import('./chunks/23-DGS_n0Mp.js')),
			__memo(() => import('./chunks/24-xiw_axdN.js'))
		],
		remotes: {
