import { ar as run, ai as store_get, an as head, ao as attr, ak as ensure_array_like, af as attr_class, am as stringify, aj as unsubscribe_stores, _ as derived, as as invalid_default_snippet } from './index2-BZw6XBxw.js';
...
import { i as iconFor, C as CATEGORY_META } from './nodes-EH74Ecid.js';
...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    var $$store_subs;
    let { data } = $$props;
    let automations = run(() => data.automations);
    let busy = {};
...
//# sourceMappingURL=_page.svelte-BQp0ihzY.js.map
