...
import { B as BlockEditor_1, P as Preview } from './Preview-fn6b7m6K.js';
            ...
            for (let $$index_2 = 0, $$length = each_array_2.length; $$index_2 < $$length; $$index_2++) {
              ...
              if (cat.id !== category.id) {
                ...
                $$renderer4.option({ value: cat.id, class: "p-1" }, ($$renderer5) => {
                  $$renderer5.push(`${escape_html(emoji.get(cat.emoji) ?? "")} ${escape_html(cat.name)}`);
                });
              } else {
                $$renderer4.push("<!--[!-->");
              }
...
//# sourceMappingURL=_page.svelte-BP3-_Iby.js.map
