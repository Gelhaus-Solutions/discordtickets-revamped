import { ah as getContext, F as setContext, an as head, av as ssr_context, _ as derived, ao as attr, af as attr_class, ag as clsx, al as attr_style, aw as attributes, am as stringify, ax as to_array, ay as hasContext, ar as invalid_default_snippet, ak as ensure_array_like, au as bind_props, az as run, aA as is_array, aB as get_prototype_of, aC as object_prototype, aD as exclude_from_object, aq as spread_props, aE as css_props, as as fallback } from './index2-B7lo9Ma0.js';
...
function ButtonsField($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    if (targets().length === 0) {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<p class="rounded-lg bg-amber-400/10 p-2 text-xs text-amber-700 dark:text-amber-300">Make an automation whose trigger is <span class="font-semibold">A button is pressed</span> first —
      ...
      for (let i = 0, $$length = each_array.length; i < $$length; i++) {
        ...
        $$renderer2.select(
          ...
          ($$renderer3) => {
            ...
            for (let $$index = 0, $$length2 = each_array_1.length; $$index < $$length2; $$index++) {
              let target = each_array_1[$$index];
              $$renderer3.option({ value: target.key }, ($$renderer4) => {
        ...
        $$renderer2.select(
          ...
          ($$renderer3) => {
            $$renderer3.push(`<!--[-->`);
            const each_array_2 = ensure_array_like(STYLES);
            for (let $$index_1 = 0, $$length2 = each_array_2.length; $$index_1 < $$length2; $$index_1++) {
              let style = each_array_2[$$index_1];
...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    let name = data.automation?.name ?? "New automation";
    let enabled = data.automation?.enabled ?? true;
    let testing = false;
    ...
    JSON.stringify({ enabled, graph: starting, name });
...
//# sourceMappingURL=_page.svelte-hUsPwbdZ.js.map
