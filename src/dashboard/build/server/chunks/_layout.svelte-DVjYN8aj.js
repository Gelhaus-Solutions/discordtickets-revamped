import {
	an as head, k as store_get, l as unsubscribe_stores, ak as ensure_array_like, a3 as derived, c as setContext, ap as await_block, aq as spread_props,
...
class ModalStack {
   ...
   * If closing was prevented by any modal, it returns false
   */
	closeAll = () => this.close(this.stack.length);
}
...
function _layout($$renderer, $$props) {
	$$renderer.component($$renderer2 => {
		...
		{
			const backdrop = function($$renderer3, { close }) {
...
// # sourceMappingURL=_layout.svelte-DVjYN8aj.js.map
