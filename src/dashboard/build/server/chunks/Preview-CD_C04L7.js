import { ao as attr, ar as bind_props, f as attr_class, am as stringify, ak as ensure_array_like, al as attr_style, a1 as derived } from './index2-BjPIasya.js';
import { e as escape_html } from './escaping-CqgfEcN3.js';
import './root-BZvlTPwp.js';
import './exports-7ECo9oy7.js';
import './state.svelte-B7ni-XI1.js';
import { e as emojiNames, d as displayEmoji } from './emoji-BSutn8sX.js';
  ...
  $$renderer.component(($$renderer2) => {
    ...
    function $$render_inner($$renderer3) {
      ...
      if (buttons.length >= LIMITS.rowButtons) {
        $$renderer3.push("<!--[-->");
        $$renderer3.push(`<p class="text-xs text-gray-500 dark:text-slate-400">A row can hold at most ${escape_html(LIMITS.rowButtons)} buttons. Add another Buttons block for more.</p>`);
      } else {
        $$renderer3.push("<!--[!-->");
        $$renderer3.push(`<div class="flex gap-2"><button type="button" class="rounded-lg bg-gray-200 px-3 py-1 text-sm font-medium transition duration-300 hover:bg-blurple hover:text-white dark:bg-slate-700"><i class="fa-solid fa-plus"></i> Ticket button</button> <button type="button" class="rounded-lg bg-gray-200 px-3 py-1 text-sm font-medium transition duration-300 hover:bg-blurple hover:text-white dark:bg-slate-700"><i class="fa-solid fa-link"></i> Link button</button></div>`);
      }
      $$renderer3.push(`<!--]--></div>`);
    }
    do {
...
export { BlockEditor_1 as B, EmojiPicker as E, Preview as P, newLayout as a, hasEntryPoint as h, newBlock as n };
//# sourceMappingURL=Preview-CD_C04L7.js.map
