import {
	ao as attr, ak as ensure_array_like, f as attr_class, am as stringify,
...
function _page($$renderer, $$props) {
	$$renderer.component($$renderer2 => {
		...
		const autoTag = Array.isArray(settings.autoTag) ? 'custom' : settings.autoTag;
		const loading = false;
		...
		$$renderer2.select(
			...
			$$renderer3 => {
				...
				for (let $$index_1 = 0, $$length = each_array_1.length; $$index_1 < $$length; $$index_1++) {
					const role = each_array_1[$$index_1];
					$$renderer3.option({
						value: role.id,
						class: 'm-1 rounded p-1',
						style: role._style,
		...
		$$renderer2.select({
			...
			for (let $$index_2 = 0, $$length = each_array_2.length; $$index_2 < $$length; $$index_2++) {
				const locale = each_array_2[$$index_2];
				$$renderer3.option({
					value: locale,
					class: 'p-1',
				}, $$renderer4 => {
		...
		$$renderer2.select(
			...
			$$renderer3 => {
				...
				for (let $$index_3 = 0, $$length = each_array_3.length; $$index_3 < $$length; $$index_3++) {
					const channel = each_array_3[$$index_3];
					$$renderer3.option({
						value: channel.id,
						class: 'p-1',
					}, $$renderer4 => {
		...
		if (data.analytics) {
			...
			if (data.analytics.byAssignee && Object.keys(data.analytics.byAssignee).length > 0) {
				...
				for (let $$index_6 = 0, $$length = each_array_6.length; $$index_6 < $$length; $$index_6++) {
					const [assigneeId, stats] = each_array_6[$$index_6];
