import { ar as bind_props, f as attr_class, am as stringify, ak as ensure_array_like, al as attr_style, ao as attr, a1 as derived } from './index2-BjPIasya.js';
  ...
  $$renderer.component(($$renderer2) => {
    ...
    for (let i = 0, $$length = each_array.length; i < $$length; i++) {
      ...
      if (button.kind === "ticket") {
        ...
        $$renderer2.select(
          ...
          ($$renderer3) => {
            $$renderer3.option({ value: null, disabled: true }, ($$renderer4) => {
              $$renderer4.push(`Choose a category`);
            });
            $$renderer3.push(`<!--[-->`);
        ...
        $$renderer2.push("<!--[!-->");
        $$renderer2.push(`<label class="text-sm"><span class="font-medium">URL</span> <input type="url" class="input form-input text-sm"${attr("value", button.url)}/></label>`);
      }
      $$renderer2.push(`<!--]--> <label class="text-sm"><span class="font-medium">Label</span> <input type="text" maxlength="80" class="input form-input text-sm"${attr("placeholder", button.kind === "ticket" ? "The category's name" : "")}${attr("value", button.label ?? "")}/></label> <label class="text-sm"><span class="font-medium">Emoji</span> <input type="text" class="input form-input text-sm"${attr("placeholder", button.kind === "ticket" ? "The category's emoji" : "")}${attr("value", button.emoji ?? "")}/></label> `);
      if (button.kind === "ticket") {
        $$renderer2.push("<!--[-->");
        $$renderer2.push(`<label class="text-sm"><span class="font-medium">Colour</span> `);
        $$renderer2.select({ class: "input form-multiselect text-sm", value: button.style }, ($$renderer3) => {
          $$renderer3.option({ value: null }, ($$renderer4) => {
            $$renderer4.push(`Automatic`);
          });
          $$renderer3.option({ value: "primary" }, ($$renderer4) => {
            $$renderer4.push(`Blurple`);
          });
          $$renderer3.option({ value: "secondary" }, ($$renderer4) => {
            $$renderer4.push(`Grey`);
          });
          $$renderer3.option({ value: "success" }, ($$renderer4) => {
            $$renderer4.push(`Green`);
          });
          $$renderer3.option({ value: "danger" }, ($$renderer4) => {
            $$renderer4.push(`Red`);
          });
        });
        $$renderer2.push(`</label>`);
    ...
    if (buttons.length >= LIMITS.rowButtons) {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<p class="text-xs text-gray-500 dark:text-slate-400">A row can hold at most ${escape_html(LIMITS.rowButtons)} buttons. Add another Buttons block for more.</p>`);
    } else {
      $$renderer2.push("<!--[!-->");
      $$renderer2.push(`<div class="flex gap-2"><button type="button" class="rounded-lg bg-gray-200 px-3 py-1 text-sm font-medium transition duration-300 hover:bg-blurple hover:text-white dark:bg-slate-700"><i class="fa-solid fa-plus"></i> Ticket button</button> <button type="button" class="rounded-lg bg-gray-200 px-3 py-1 text-sm font-medium transition duration-300 hover:bg-blurple hover:text-white dark:bg-slate-700"><i class="fa-solid fa-link"></i> Link button</button></div>`);
    }
    $$renderer2.push(`<!--]--></div>`);
...
function BlockFields($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    let { block = void 0, categories, context } = $$props;
    ...
    function $$render_inner($$renderer3) {
      if (BLOCK_META[block.type]?.dynamic) {
        ...
        if (block.accessory?.kind === "thumbnail") {
          ...
          $$renderer3.push("<!--[1-->");
          ButtonList($$renderer3, { buttons: [block.accessory.button], categories });
        } else {
          $$renderer3.push("<!--[!-->");
        }
        $$renderer3.push(`<!--]--></div>`);
...
function Preview($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    const buttonLabel = (button) => button.kind === "link" ? button.label || "Link" : button.label || categoryName(button.categoryId);
    const buttonEmoji = (button) => button.emoji || (button.kind === "ticket" ? categoryEmoji(button.categoryId) : "");
    ...
    const each_array_2 = ensure_array_like(layout?.blocks ?? []);
    for (let $$index_3 = 0, $$length = each_array_2.length; $$index_3 < $$length; $$index_3++) {
      let block = each_array_2[$$index_3];
      if (block.type === "container") {
        $$renderer2.push("<!--[-->");
        ...
        const each_array_3 = ensure_array_like(block.blocks ?? []);
...
//# sourceMappingURL=Preview-fn6b7m6K.js.map
