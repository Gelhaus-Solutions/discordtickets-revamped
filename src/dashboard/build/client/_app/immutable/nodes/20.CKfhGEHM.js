import{ e as fe }from'../chunks/Cxx9n8vM.js';import'../chunks/Bzak7iHL.js';import{ o as me }from'../chunks/BAc9Nw6w.js';import{
	...
	let $, G, V;be(u, !0);const c=()=>Ae(ze, '$page', g), [g, p]=Ue();const l=_(!1), h=_(!1), v=_(null), b=_(''), i=ge({
		...
		};const E=Ne(), F=a(Z(E), 2), N=s(F);{ const te=e=>{
		je(e, {
			get error(){
				return n(v);
			},
		...
		n(v)&&e(te);
	}); }const O=a(N, 2);{ const ae=e=>{
		const t=Ie(), d=a(s(t));o(t), I(()=>M(d, ` ${n(b)??''}`)), f(e, t);
	};y(O, e=>{
		n(b)&&e(ae);
	}); }const x=a(O, 4), re=ye(()=>Be(()=>ee())), w=s(x), B=s(w), P=a(s(B), 2), D=s(P);{ const se=e=>{
			const t=Te(), d=Z(t), j=a(d, 2);I(()=>we(d, 'src', i.botAvatar)), T('click', j, ()=>X('botAvatar')), f(e, t);
		}, oe=e=>{
			const t=Me();f(e, t);
		};y(D, e=>{
		i.botAvatar?e(se):e(oe, !1);
	}); }const ie=a(D, 2);o(P), o(B);const U=a(B, 2), A=a(s(U), 2);ke(A);const J=a(A, 2), le=s(J);o(J), o(U);const L=a(U, 2), z=a(s(L), 2);_e(z);const q=a(z, 2), ne=s(q);o(q), o(L), o(w);const R=a(w, 2), S=s(R), de=s(S);{ const ce=e=>{
			const t=Ee();f(e, t);
		}, ue=e=>{
			const t=Fe();f(e, t);
		};y(de, e=>{
		n(h)?e(ce):e(ue, !1);
	}); }K(), o(S), K(2), o(R), o(x), o(F), I(()=>{
		let e, t;M(le, `${(((e=i.botUsername)==null?void 0:e.length)||0)??''}/80`), M(ne, `${(((t=i.botBio)==null?void 0:t.length)||0)??''}/500`), S.disabled=!n(l)||n(h);
	}), he('submit', x, function(...e){
		let t;(t=n(re))==null||t.apply(this, e);
	}), T('change', x, e=>{
		e.target.type!=='file'&&r(l, !0);
	}), T('change', ie, e=>W(e, 'botAvatar')), Q(A, ()=>i.botUsername, e=>i.botUsername=e), Q(z, ()=>i.botBio, e=>i.botBio=e), f(k, E), xe(), p();
}pe(['change', 'click']);export{
